...
export default function TVRecommendations({ analytics }) {
  ...
  return (
    <motion.div
      ...
      className="glass rounded-2xl p-6 neon-border-magenta"
    >
      <div className="flex items-center gap-3 mb-4">
        <Sparkles className="text-neon-magenta" size={24} />
        <h2 className="text-xl font-bold neon-text-magenta">TV Recommendations</h2>
      </div>
      ...
      {favoriteGenre ? (
        <div className="space-y-4">
          <div className="flex items-center gap-2 text-white/80">
            ...
            <span className="font-semibold text-neon-magenta">{favoriteGenre}</span>
          </div>
